        ...
        <div class="flex justify-between">
            ...
            <div class="right w-1/2 flex items-center">
                <div class="w-2/4">
                    ...
                    <p class="text-sm mt-6 leading-6 opacity-50 tracking-2">Nhập địa chỉ email đã đăng kí. Chúng mình sẽ gửi cho bạn hướng dẫn đặt lại mật khẩu qua email này.</p>
                    <form action="">
                        <div class="mt-8">
                            <label class="text-sm">Email</label> <br>
                            <input class="w-full border px-6 py-4 rounded-md mt-2" type="email" placeholder="etrade@gmail.com" style="border: 1px solid #ccd3d8;">
                        </div>
                    </form>

                    <div class="flex justify-between items-center mt-8">
                        <button class="px-8 py-4 rounded-md text-white font-bold transform hover:scale-110 transition duration-300" style="background-color: #4676e8;">Đặt lại mật khẩu</button>                      
                    </div>
                </div>
